...
urlpatterns += [
    ...
    url(r'^storage/rerecognize/?$', io_handling.rerecognize_storage_request),
...
urlpatterns += [
    ...
    url(r'^movie/recognize_multiple/?$', io_handling.recognize_multiple_movies_request),
    ...
    url(r'^movie/merge_multiple/?$', io_handling.merge_multiple_movies_request),
